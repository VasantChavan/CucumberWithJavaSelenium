...
/*	WebDriver driver;
	...
	public void afterMethod(Scenario scn) {
		this.scn = scn;
		scn.write("afterMethod().........");
		scn.write("quit the browser instance ...........");
		driver.quit();
	}
	...
	@When("^titile of the login page is FreeCrmPro$")
	public void titile_of_the_login_page_is_FreeCrmPro() {
	...
	@Then("^user enter user and password$")
